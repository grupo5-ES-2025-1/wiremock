...
class ProxiedHostnameRewriteResponseTransformerTest {
  ...
  void init(WireMockConfiguration proxyingServiceOptions) {
    ...
    targetServiceBaseUrl = "http://127.0.0.1:" + targetService.port();
        ...
        get(urlPathEqualTo("/start"))
            .willReturn(
                aResponse()
                    ...
                    .withHeader(LOCATION, "http://127.0.0.1:" + targetService.port() + "/end")));
  ...
  public void rewritesTheHostnameInUngzippedBodyWhenEnabledAndResponseIsProxied() {
    ...
    String responseString = "{ \"link\": \"http://127.0.0.1/other\" }";
